...
" +
                    "Generated by Vantage DQ · " + new Date().toLocaleDateString("en-GB",{day:"numeric",month:"long",year:"numeric"}) + "
...
" +
                    "Growth: " + modelParams.growthRate + "% · Cost margin: " + modelParams.costMargin + "% · WACC: " + modelParams.discount + "% · Horizon: " + modelParams.horizon + " years

" +
                    "INCOME STATEMENT (Low / Base / High per year)
" +
                    fmtRow("Revenue", modelResult.revenue) + "
" +
                    fmtRow("Costs",   modelResult.costs) + "
" +
                    fmtRow("EBITDA",  modelResult.ebitda) + "

" +
                    "VALUATION
" +
                    "NPV:     Low " + (modelResult.npv?.low??"-") + "  Base " + (modelResult.npv?.base??"-") + "  High " + (modelResult.npv?.high??"-") + " " + modelParams.currency + "
" +
                    "IRR:     Low " + (modelResult.irr?.low??"-") + "%  Base " + (modelResult.irr?.base??"-") + "%  High " + (modelResult.irr?.high??"-") + "%
" +
                    "Payback: Low " + (modelResult.payback?.low??"-") + "  Base " + (modelResult.payback?.base??"-") + "  High " + (modelResult.payback?.high??"-") + " years

" +
                    "SCENARIO NARRATIVES
" +
                    "Low:  " + (modelResult.scenarioLow||"") + "
" +
                    "Base: " + (modelResult.scenarioBase||"") + "
" +
                    "High: " + (modelResult.scenarioHigh||"") + "

" +
                    "KEY RISKS
" +
                    (modelResult.keyRisks||[]).map((r,i)=>(i+1)+". "+r).join("
") + "

" +
                    (modelResult.notes?"MODELLING NOTES
"+modelResult.notes+"

":"") +
                    "---
Generated by Vantage DQ Decision Quality Platform
