...
const QUESTIONS = [
  ...
  },
  {
    ...
    placeholder: 'e.g., Build direct subsidiary, Strategic partnership with local player, Acquire existing APAC operator, Phased entry via agent/reseller',
    type: 'multi' as const,
  ...
  },
  {
    ...
    placeholder: 'e.g., CEO, CFO, Board Investment Committee, CTO, Regional Head APAC, General Counsel',
    type: 'multi' as const,
  ...
  },
  {
    ...
    placeholder: 'e.g., Hard: $25M Year 1 ceiling, Board mandate to enter APAC by Q3, Data residency requirements. Soft: Preserve strategic flexibility, minimise cultural disruption.',
  ...
  },
  {
    ...
    placeholder: 'e.g., Board mandate after competitor entered Singapore. If we wait 12 months, competitive position becomes uncatchable.',
    type: 'textarea' as const,
